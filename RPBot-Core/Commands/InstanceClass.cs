...
namespace RPBot
{
    [Group("instance"), Description("Instance commands"), IsMuted, IsStaff]
    class InstanceClass : BaseCommandModule
    {
        [Command("add"), Description("Command to create a new location instance.")]
        ...
        [Command("end"), Description("Command to end a roleplay.")]
        ...
        [Command("destroy"), Description("Command to delete an instance.")]
        ...
        [Command("addtemplate"), Description("Admin command to add a channel template to the list.")]
